...
class App extends Component {
  ...
  componentDidMount() {
    this.setState({result: "Click a pokemon to begin!"})
  }
  ...
  pointIncrease = () => {
    ...
    if (score === this.state.PokemonCard.length) {
      this.setState({
  ...
  resetPokemonCardArray = () => {
    let newScramble = shuffleArray(Pokemon);
    this.setState({PokemonCard: newScramble})
  }
